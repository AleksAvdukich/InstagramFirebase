...
//  InstagramFirebase
//
//  Created by Aleksandr Avdukich on 20/12/2018.
...
class PhotoSelectorController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    fileprivate func fetchPhotos() {
        ...
        let sortedDescriptor = NSSortDescriptor(key: "creationDate", ascending: false)
        fetchOptions.sortDescriptors = [sortedDescriptor]
